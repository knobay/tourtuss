...
<body>
    ...
    <section data-role="page" id="destination">
        <header data-role="header" data-position="fixed" data-theme="a">
                ...
                <h1>
                <a href="search.php" data-transition="none">
                  <span class="flag-icon flag-icon-squared flag-icon-cl"></span> Santiago <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>
                </a>
                </h1>
...
<!-- pop down panel -->
        ...
        <header data-role="header" data-position="fixed" data-theme="a">
                ...
                <a href="#destination" data-transition="none">
                  <span class="flag-icon flag-icon-squared flag-icon-cl"></span> Santiago  <span class="flag-icon flag-icon-squared flag-icon-cl"></span>
