     <section data-role="page" id="page-experience-detail" data-theme="a">

        <header data-role="header" data-position="fixed" data-theme="a">
            <h1>
                Colonial history walking tour <i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i>  
            </h1>
            
<p>
<?php $today = date("j F Y"); echo $today; ?>,  13:00 
</p>        
        </header>
...
<a href="#page-book" class="ui-btn"><i class="fa fa-shopping-basket"></i>+</a>
